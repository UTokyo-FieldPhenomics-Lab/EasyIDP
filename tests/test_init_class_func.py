...
from . import report_loguru_to_caplog
...
def test_def_parse_photo_relative_path_warn(report_loguru_to_caplog):
    frame_path = r"Z:\ishii_Pro\sumiPro\2022_soy_weeds_metashape_result\220613_G_M600pro\220613_G_M600pro.files\0\0\frame.zip"
    ...
    assert "Seems it is an absolute path" in report_loguru_to_caplog.text
